...
2. If yes, does the `AgentTeam` have the annotation `claude.camlabs.dev/approved/{event}=true`?
...
```bash
kubectl annotate agentteam my-team "claude.camlabs.dev/approved/spawn-email-drafter=true"
```
